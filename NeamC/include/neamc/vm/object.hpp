...
enum class ObjType
{
  ...
  // v1.0: OWASP Security
  OBJ_GOAL_INTEGRITY, OBJ_TOOL_VALIDATOR, OBJ_AGENT_IDENTITY,
  OBJ_SUPPLY_CHAIN_POLICY, OBJ_CODE_SANDBOX, OBJ_MEMORY_INTEGRITY,
  OBJ_MESSAGE_SECURITY, OBJ_CIRCUIT_BREAKER_V10, OBJ_HUMAN_GATE,
  OBJ_AGENT_ATTESTATION,
  // v1.0: MCP Security
  OBJ_MCP_ALLOWLIST, OBJ_TOOL_PINNING, OBJ_CONTEXT_GUARD,
  // v1.0: AIBOM
  OBJ_AIBOM_CONFIG,
  // v1.0: Evaluation
  OBJ_GYM_EVALUATOR,
  // v1.0: Cloud
  OBJ_GATEWAY, OBJ_MODEL_ROUTER, OBJ_MARKETPLACE_V10,
  // v1.0: Special Agents
  OBJ_SECURITY_SENTINEL_AGENT, OBJ_PROTOCOL_BRIDGE_AGENT, OBJ_COST_GUARDIAN_AGENT,
  // v1.1: NeamOS Foundation
  OBJ_KNOWLEDGE_CARD,
  OBJ_CONTEXT_ASSEMBLY,
  OBJ_AGENT_PERSONA,
  OBJ_LOCALE_CONFIG,
  OBJ_GOVERNANCE_RULE,
  OBJ_AGENT_ADAPTER,
  OBJ_BLUEPRINT,
  OBJ_KNOWLEDGE_WEAVER_AGENT,
  OBJ_ADAPT_AGENT,
  OBJ_STORYTELLER_AGENT,
};
